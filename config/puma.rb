...
# Run the Solid Queue supervisor inside of Puma only when explicitly enabled (unset on Fly to avoid queue/DB issues).
# Plain Ruby only (Rails not loaded yet); .present? would be NoMethodError
